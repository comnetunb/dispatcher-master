...
xepOnline.Formatter = {
  ...
  flattenStyle: function (elm, options) {
    ...
    if (options.processPseudoElem == 'true')		    { xepOnline.Formatter.handlePseudoElem(elm) }
...
'<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" \
  ...
  Clear: function () {
    if (jQuery(xepOnline.Formatter.__container).length === 0 ||
			jQuery(xepOnline.Formatter.__container).attr('data-xeponline-embed-pending') === 'true') { return }
