...
// Dispatcher Related
const communicationEvent = dispatcherRequire('communication').event;
const connectionManager = dispatcherRequire('connection_manager');
const performTaskResponseHandler = dispatcherRequire('dwp_handler/handler/perform_task_response_handler');
const reportHandler = dispatcherRequire('dwp_handler/handler/report_handler');
const taskResultHandler = dispatcherRequire('dwp_handler/handler/task_result_handler');
const terminateTaskResponseHandler = dispatcherRequire('dwp_handler/handler/terminate_task_response_handler');
const languageHandler = dispatcherRequire('dwp_handler/handler/language_handler');
