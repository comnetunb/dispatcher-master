...
const communication = dispatcherRequire('communication');
const slaveDiscovery = dispatcherRequire('slave_discovery');

// Shared Related
const log = sharedRequire('log');
const config = sharedRequire('configuration').getConfiguration();
const interfaceManagerEvent = sharedRequire('interface_manager').event;
