...
module.exports = function (app) {
  app.get('/api/task/get_executing', function (req, res) {
    const simulationGroupFilter = {
      state: SimulationGroup.State.Executing,
      _user: req.user._id
    }

    SimulationGroup.find(simulationGroupFilter)
      .then(function (simulationGroups) {
  ...
  app.get('/api/task/get_finished', function (req, res) {
    const simulationGroupFilter = {
  ...
  app.get('/api/task/get_remaining_instances/:id', (req, res) => {
  ...
  app.get('/api/task/count_finished', (req, res) => {
    const simulationGroupFilter = {
      state: SimulationGroup.State.Finished,
      _user: req.user.id
    }
  ...
  app.get('/api/task/export/:id', function (req, res) {
    const simulationGroupId = req.params.id
